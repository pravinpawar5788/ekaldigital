...
class Event3 extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($_POST) {           
            ...
            if ($this->form_validation->run() !== false) { 
                  $numb = rand(100,1000).".jpg"; 
                $youtubeID = $this->getYouTubeVideoId($this->input->post('path'));
           $url = 'https://img.youtube.com/vi/' . $youtubeID . '/hqdefault.jpg';
             
          file_put_contents("/var/www/html/school/$numb", file_get_contents($url));
			   ...
			   //print_r($this->input->post('joining_date')); die;
                ...
                $this->db->insert('statepath', $arrayEvent);
        ...
        $this->data['title'] = "Ekal Video";
        $this->data['sub_page'] = 'event/index_ekal';
