    ...
    public function index()
    {
        if (is_student_loggedin() || is_parent_loggedin()) {
           ...
           $this->data['income_vs_expense'] = $this->dashboard_model->getIncomeVsExpense($schoolID);
			...
			//total number 
			 $total_prabhag = $this->dashboard_model->get_total_staff();
			  $this->data['total_prabhag'] =$total_prabhag;
			  $this->data['total_sambhag'] = $this->dashboard_model->get_total_sambhag();
			   $this->data['total_bhag'] = $this->dashboard_model->get_total_bhag();
			    $this->data['total_anchal'] = $this->dashboard_model->get_total_anchal();
				 $this->data['total_sanch'] = $this->dashboard_model->get_total_friend();
				 $this->data['total_sanch1'] = $this->dashboard_model->get_total_samiti();
				   $joinuser = $this->dashboard_model->get_joinuser();
				$this->data['total_joinuser'] = $joinuser['noofuser'] + $total_prabhag;
			 $this->data['classlist'] = $this->dashboard_model->getvideotraing();
