...
<head>
	...
	<meta name="description" content="Ekal School Management System">
	<meta name="author" content="">
	<title><?php echo translate('Ekal Abhiyan');?></title>
                    ...
                    <div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                        <div class="sign-area">
                            <div class="sign-hader">
                                <img src="<?php echo base_url('uploads/app_image/logo.png');?>" height="100" alt="">
                            ...
                            <?php echo form_open($this->uri->uri_string()); ?>
                                <div class="form-group <?php if (form_error('email')) echo 'has-error'; ?>">
                                    <div class="input-group input-group-icon">
                                        ...
                                        <input type="text" style="background-color:#fff;color:#212121" class="form-control" name="email" value="<?php echo set_value('email');?>" placeholder="Username" />
                                    </div>
                                ...
                                <div class="form-group <?php if (form_error('password')) echo 'has-error'; ?>">
                                    <div class="input-group input-group-icon">
                                        ...
                                        <input type="password" style="background-color:#fff;color:#212121" class="form-control input-rounded" name="password" placeholder="<?php echo translate('password');?>" />
                                    </div>
                                ...
                                <div class="forgot-text">
                                    <div class="checkbox-replace">
                                        <label style="color:#212121" class="i-checks"><input type="checkbox" name="remember" id="remember"><i></i> <?php echo translate('remember');?></label>
                                    </div>
                                    <div class="">
