...
<section class="panel">
	...
	<div class="tabs-custom">
		...
		<!--<ul class="nav nav-tabs">
			 <li class="<?php if ("1" == $act_role) echo 'active'; ?>">
				<a href="<?php echo base_url('employee/view1/1'); ?>">
					<i class="far fa-user-circle"></i> 
                     Samiti Sadasy
				</a>
			</li>
			<li class="<?php if ("2" == $act_role) echo 'active'; ?>">
				<a href="<?php echo base_url('employee/view1/2'); ?>">
					<i class="far fa-user-circle"></i> 
                    Sevavrati Karyakarta
				</a>
			</li>
			<li class="<?php if ("3" == $act_role) echo 'active'; ?>">
				<a href="<?php echo base_url('employee/view1/3'); ?>">
					<i class="far fa-user-circle"></i> 
                    Acharya
				</a>   
			</li>
			<li class="<?php if ("5" == $act_role) echo 'active'; ?>">
				<a href="<?php echo base_url('employee/view1/5'); ?>">
					<i class="far fa-user-circle"></i> 
                    Guest
				</a>
			</li>
			<li class="<?php if ("6" == $act_role) echo 'active'; ?>">
