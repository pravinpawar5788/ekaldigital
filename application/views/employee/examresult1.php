...
$live_tv_categoriesmcq1 = $db2->get_where('quiz_result',array('category_id'=>7, 'studid'=>$fields['id']))->num_rows();										  
                                             $live_tv_categoriesmcq = $db2->get_where('quiz_result',array('category_id'=>7,'score'=>1, 'studid'=>$fields['id']))->num_rows();
											  ?>
							<td>20</td>
