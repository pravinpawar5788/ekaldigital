	...
	<div class="col-md-5">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-edit"></i> <?php echo translate('add') . " vidhan sabha"; ?></h4>
			</header>
			<?php echo form_open($this->uri->uri_string()); ?>
				...
				<?php if (is_superadmin_loggedin()): ?>
					...
					<div class="form-group">
						...
						//$arrayPrabhag = $this->app_lib->getClass($branch_id);
						echo form_dropdown("a_name", $arrayPrabhag, set_value('a_name'), "class='form-control' id='a_name'
						data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
					?>
					</div> 
				...
				<?php endif; ?>
					<div class="form-group mb-md">
						<label class="control-label">Vidhan Sabha Name<span class="required">*</span></label>
						<input type="text" class="form-control" name="sanch_name" value="<?php echo set_value('s_name'); ?>" />
						<span class="error"><?=form_error('s_name')?></span>
					</div>
					
					<div class="form-group mb-md">
						<label class="control-label">Vikas Khand Name<span class="required">*</span></label>
						<input type="text" class="form-control" name="sanch_name1" value="<?php echo set_value('s_name1'); ?>" />
						<span class="error"><?=form_error('s_name1')?></span>
					</div>
					...
					<table class="table table-bordered table-hover table-condensed mb-none">
						<thead>
							<tr>
								...
								<th><?php echo translate('anchal'); ?></th>
								<th>Vidhan Sabha</th>
									<th>Vikas Khand</th>
						...
						?>
							<tr>
								...
								<?php  endif; if (get_permission('department', 'is_delete')): ?>
									<?php echo btn_delete('employee/sanch_delete/' . $row['id']); ?>
								<?php endif; ?>
								</td>
							</tr>
						<?php
