...
function getPrabhagByState(state_id) {
    $.ajax({
        url: base_url + 'ajax/getPrabhagByState', 
        type: 'POST',
        data:{ branch_id: state_id },
        success: function (data){
            $('#p_name').html(data);
        }
    });
    $('#section_id').html('');
    $('#section_id').append('<option value="">Select state First</option>');
}


function getSambhagByPrabhag(prabhag_id) {
    $.ajax({
        url: base_url + 'ajax/getSambhagByPrabhag', 
        type: 'POST',
        data:{ branch_id: prabhag_id },
        success: function (data){
            $('#s_name').html(data);
        }
    });
    $('#section_id').html('');
    $('#section_id').append('<option value="">Select prabhag First</option>');
}

function getSambhagByPrabhag1(prabhag_id) {
...
function getBhagBySambhag(sambhag_id) {
	
    $.ajax({
        url: base_url + 'ajax/getBhagBySambhag', 
        type: 'POST',
        data:{ branch_id: sambhag_id },
        success: function (data){
            $('#b_name').html(data);
        }
    });
    $('#section_id').html('');
    $('#section_id').append('<option value="">Select sambhag First</option>');
}

function getAnchalByBhag(bhag_id) {
	
    $.ajax({
        url: base_url + 'ajax/getAnchalByBhag', 
        type: 'POST',
        data:{ branch_id: bhag_id },
        success: function (data){
            $('#a_name').html(data);
        }
    });
    $('#section_id').html('');
    $('#section_id').append('<option value="">Select bhag First</option>');
}

function getSanchByAnchal(anchal_id) { 

	
    $.ajax({
        url: base_url + 'ajax/getSanchByAnchal', 
        type: 'POST',
        data:{ branch_id: anchal_id },
        success: function (data){
            $('#branch_id').html(data);
        }
    });
    $('#section_id').html('');
    $('#section_id').append('<option value="">Select anchal First</option>');
}
...
// get department details
function getPrabhagDetails(id) {
    $.ajax({
        url: base_url + 'ajax/prabhag_details',
        type: 'POST',
        data: {'id': id},
        dataType: "json",
        success: function (data) {
            $('.error').html("");
            $('#edepartment_id').val(data.id);
            $('#cdepartment_name').val(data.p_name);
            $('#ebranch_id').val(data.state_name).trigger('change');
            mfp_modal('#modal');
        }
    });
}
...
// get sambhag details
function getSambhagDetails(id) {
	
    $.ajax({
        url: base_url + 'ajax/sambhag_details',
        type: 'POST',
        data: {'id': id},
        dataType: "json",
        success: function (data) {
            $('.error').html("");
            $('#edepartment_id').val(data.id);
            $('#cdepartment_name').val(data.s_name);
            $('#ebranch_id').val(data.p_id).trigger('change');
            mfp_modal('#modal');
        }
    });
}
...
// get sambhag details
function getBhagDetails(id) {
	
    $.ajax({
        url: base_url + 'ajax/bhag_details',
        type: 'POST',
        data: {'id': id},
        dataType: "json",
        success: function (data) {
            $('.error').html("");
            $('#edepartment_id').val(data.id);
            $('#cdepartment_name').val(data.b_name);
			$('#ebranch_id').val(data.p_id).trigger('change');
            //$('#es_id').val(data.s_id).trigger('change');
            mfp_modal('#modal');
        }
    });
}
